...
public class Document implements Serializable {
	 ...
	 * @param extra
	 */
	public Document(Long id, String attribution, String contributors, String notes, String doi, Date lastRevised,
			Long licenseId, String title, String type, Long uFileId, Date fromDate, Date toDate, Integer rating,
			String author, String journal, String bookTitle, String year, String month, String volume, String number,
			String pages, String publisher, String school, String edition, String series, String address,
			String chapter, String note, String editor, String organization, String howPublished, String institution,
			String url, String language, String file, String itemtype, String isbn, String extra) {
		super();
		this.id = id;
